                                ...
                                prices && (
                                    <>
                                        {prices.map((price) => (
                                            ...
                                            <div key={price.id} className={clsx('border-2 bg-gray-100 shadow-md h-full w-full rounded-lg scale-100 hover:scale-110 ease-in duration-200', price.name === 'VIP' ? 'border-[#E97665]' : '')}>
