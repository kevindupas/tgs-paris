        ...
        <section className="relative py-16 bg-[url('/dist/images/pattern-semi-dark.png')] sm:py-20 lg:py-24">
            ...
            <div className="max-w-[1200px] mx-8 lg:mx-auto">
                ...
                <div className="grid grid-cols-2 gap-5 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Link to="faqs" className="w-full bg-[#E97665] hover:scale-105 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                    ...
                    <a href={config.plan_pdf !== '' ? URL + config.plan_pdf : '#'} target="_blank" className="w-full bg-[#E97665] hover:bg-blue-400  rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center" rel="noreferrer">
                        <div className="mb-8 hidden lg:block">
                    ...
                    <a href={config.planning_pdf !== '' ? URL + config.planning_pdf : '#'} target="_blank" className="w-full bg-[#E97665]0 hover:bg-blue-400  rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center" rel="noreferrer">
                        <div className="mb-8 hidden lg:block">
                    ...
                    <Link to="informations-pratiques" className="w-full bg-[#E97665] hover:bg-blue-400  rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                        <div className="mb-8 hidden lg:block">
                            <i className="fa-regular fa-circle-question text-7xl text-white" />
                        </div>
                        <div className="text-center">
