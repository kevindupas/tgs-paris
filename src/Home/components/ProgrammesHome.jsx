...
function ProgrammesHome({ category, salon, tag, limit }) {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      fetch(
        `${URL}/api/posts/categories/${category}/salon/${salon}?limit=${limit}`,
        options
      )
  ...
  return (
    <section className="relative w-full py-16 sm:py-24 bg-zinc-900">
      <div className="max-w-[1200px] w-[calc(100%-30px)] mx-auto flex justify-start items-start flex-wrap">
        <div className="grid grid-cols-1 gap-4 mx-auto lg:flex justify-center items-center w-full h-full space-x-0 lg:space-x-10">
          <div className="mx-auto">
            <div className="mr-0 relative z-10 text-white">
              {/* <p className="text-base mb-2 ml-28 font-semibold uppercase">artistes</p> */}
              <h1 className="mb-2 text-center font-oswald text-[40px] lg:text-[40px] tracking-[0.566667px] leading-[.95] uppercase">
                Programmes
              </h1>
              ...
              <table className="min-w-full">
                <tbody>
                  <tr>
                    <td className="whitespace-nowrap pl-4 pr-3 text-right text-sm font-medium text-gray-900 sm:pl-6 artiste text-[40px] lg:text-[68px] font-oswald tracking-[0.566667px] leading-[.95] uppercase">
                      400
                    </td>
                    <td className="whitespace-nowrap px-3 pt-[25px] text-sm text-white flex-shrink-0 font-tungstenb_semibold font-semibold text-[45px] tracking-[0.566667px] leading-[.95] uppercase">
                      exposants
                    </td>
                  </tr>
                  <tr>
            ...
            <div className="py-[30px] lg:py-[43px] flex justify-center items-center">
              <Link
                to="programmes"
                className="inline-block text-center cursor-pointer bg-white py-5 px-11"
              >
          ...
          <div className="w-full lg:w-full h-full flex mx-auto justify-center items-center relative lg:left-20">
