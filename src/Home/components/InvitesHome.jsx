...
export default function InvitesHome({ category, salon, tag, limit }) {
    ...
    <section className="relative w-full py-16 bg-zinc-900">
      <div className="max-w-[1200px] w-[calc(100%-30px)] mx-auto flex justify-start items-start flex-wrap">
        <div className="mx-auto max-w-2xl mb-10">
          <h1 className="mb-2 text-center font-oswald text-[40px] lg:text-[48px] tracking-[0.566667px] leading-[.95] uppercase text-white">
            Invités
          </h1>
          <hr className="relative lg:left-0 w-[calc(100% + 130px)]" />
        </div>
        <div className="w-full lg:w-full h-full flex mx-auto justify-center items-center relative">
          {invites.length !== 0 ? (
            <Carousel>
              {invites &&
                invites.map((data) => {
                      ...
                      >
                        <div className="news-card">
                          ...
                          <div className="news-card__text-wrapper w-full">
                            <h2 className="news-card__title font-bold">
                              {data.name}
                            </h2>
