                ...
                <div className="max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
                    <div className="sm:flex sm:flex-col sm:align-center">
                        ...
                        <p className="text-red-400 text-2xl text-center mt-6 uppercase font-bold">
                            <FontAwesomeIcon icon={faTriangleExclamation} className="text-2xl mx-2" />
                        ...
                        >
                            {
                                prices && (
                                    <>
                                        {prices.map((price) => (
                                            <div key={price.id} className={clsx('border-2 bg-gray-100 shadow-lg h-full w-full rounded-lg scale-100 hover:scale-110 ease-in duration-200', price.name === 'VIP' ? 'border-[#E97665]' : '')}>
                                                { price.name === 'VIP' && (<span className="absolute flex -top-3 rounded-full px-3 left-0 w-36 right-0 mx-auto justify-center items-center text-white bg-[#E97665]">Quantité limitée</span>) }
                                                <div className="p-6">
