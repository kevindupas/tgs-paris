    ...
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
            <div
                ...
                style={{ backgroundImage: `url(${URL + config.salon_pop_culture_image})` }}
            >
                ...
                <div className="relative isolate overflow-hidden">
                    <div className="max-w-7xl pt-10 pb-24 sm:pb-32 lg:py-36">
                        ...
                        <div className="mt-20 sm:mt-24 md:mx-auto lg:mx-0 lg:mt-0">
                            <Slide triggerOnce>
                                <h1 className="font-heading_bold absolute tracking-[0.566667px] text-5xl leading-[.95] w-[650px] left-8 -top-12 uppercase text-[#E97665]">
                                    LE SALON DE
                                    {' '}
                                    <br />
                ...
                <div className="absolute w-full h-full overflow-hidden">
                    ...
                    <div className="absolute right-0 bottom-0 h-28 w-28">
                        ...
                        <div
                            className={clsx(
                                'absolute -left-32 top-0 w-[300px] transform -rotate-[45deg] shadow-lg text-center text-white font-heading_bold font-bold py-1 uppercase',
                ...
                <Slide direction="right" triggerOnce>
                    <div className="relative isolate overflow-hidden">
                        ...
                        <div className="mt-10 flex justify-center items-center">
                            <a href="https://photos.tgs-paris.fr" target="_blank" className="inline-block text-center cursor-pointer py-5 px-11" rel="noreferrer">
                                <img
