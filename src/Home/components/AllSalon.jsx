      ...
      .then(
        (data) => {
          ...
          const sortedData = data.data.sort(
            (a, b) => new Date(a.countdown) - new Date(b.countdown)
          );
  ...
  if (allSalon) {
    return (
      <div
        ...
        style={{ backgroundImage: `url(${URL + config.all_salon_image})` }}
      >
        <div className="mx-auto max-w-7xl py-12 px-4 text-center sm:px-6 lg:px-8 lg:py-24">
          <div className="space-y-8 sm:space-y-12">
            <div className="space-y-5 sm:mx-auto sm:max-w-xl sm:space-y-4 lg:max-w-5xl">
              <h2 className="text-4xl text-black font-bold font-oswald tracking-[0.566667px] leading-[.95] uppercase">
                Nos events
              </h2>
              <p className="text-xl text-gray-700 font-bold">
                Retrouvez nos autres salons.
              </p>
            </div>
                      ...
                      <div className="space-y-4" key={value.id}>
                        ...
                        >
                          <img
                            className={clsx(
                              "mx-auto h-auto",
                              value.name !== "TGS Springbreak"
                                ? "w-44"
                                : "w-[13.4rem]"
                            )}
                            src={URL + value.event_logo}
                            alt=""
                          />
                        </a>
