...
export default function Newsletter() {
  ...
  function handleSubmit(e) {
    const newsletters = { email, code_postal, salon: "TGS Paris" };
    e.preventDefault();
  ...
  return (
    <div className="bg-[#E97665]">
      <div className="max-w-[1400px] mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center">
        <div className="lg:w-0 lg:flex-1">
          <h2 className="text-3xl lg:text-4xl text-white font-oswald tracking-[0.566667px] leading-[.95] uppercase">
            Newsletters
          </h2>
          <p className="mt-3 max-w-3xl font-bold text-lg leading-6 text-gray-300">
            Pour rester toujours au courant !
          </p>
        </div>
        <div className="mt-8 lg:mt-0 lg:ml-8">
          <form className="sm:flex px-5" onSubmit={handleSubmit}>
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <label htmlFor="code_postal" className="sr-only">
                Code postal
              </label>
              <input
                id="code_postal"
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-500 hover:bg-blue-700 focus:outline-none"
              >
                Envoyer
              </button>
            </div>
          ...
          <p className="mt-3 lg:ml-5 text-sm text-gray-300">
            {errors ? (
              <p className="text-red-900">
                Email ou code postale non valide, (exemple code postale : 31000)
              </p>
            ) : (
              success && (
