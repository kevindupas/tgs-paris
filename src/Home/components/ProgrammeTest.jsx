                ...
                >
                    ...
                    {invites && invites.some((data) => data.forward?.length !== 0) ? (
                                            ...
                                            <div className="news-card">
                                                ...
                                                <div className="news-card__text-wrapper w-full">
                                                    ...
                                                    <div className="news-card__details-wrapper">
                                                        ...
                                                        <Link className="news-card__read-more bg-black hover:bg-blue-400 text-[#E97665] hover:text-black" to={`/post/${data.id}`}>
                                                            En savoir plus
                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center bg-gray-200 p-6 rounded shadow-md">
                            ...
                            <h2 className="text-3xl font-bold text-gray-800 mt-5">Nous arrivons avec plein de surprises</h2>
                        </div>
                    )}
                </div>
