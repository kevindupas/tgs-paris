...
export default function ProgrammeTest({ category, salon, tag, limit }) {
    ...
    <section className="relative w-full py-16 bg-[#f3f3f3]">
      <div className="lg:max-w-[1200px] lg:w-[calc(100%-30px)] mx-auto flex justify-start items-start flex-wrap">
        <div className="mx-auto max-w-2xl mb-10">
          <h1 className="mb-2 text-center font-oswald text-[27px] lg:text-[48px] tracking-[0.566667px] leading-[.95] uppercase text-black">
            Programmes
          </h1>
