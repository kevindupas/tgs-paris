...
export default function PartnerTest() {
  ...
  const falseElements =
    !!partners && partners.filter((element) => element.sponsors === false);
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
                <div className="mx-auto w-full max-w-xl lg:mx-0">
                  <h2 className="text-3xl lg:text-4xl font-bold tracking-tight text-gray-900 uppercase w-56 font-oswald">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {isDesktop && (
                  <div className="flex justify-end items-center">
                    <Link
                      to="partenaires"
                      className="inline-flex items-center rounded-md border border-transparent bg-[#E97665] px-4 py-2 text-base font-medium text-white uppercase shadow-sm hover:bg-blue-400"
                    >
