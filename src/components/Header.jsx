                    ...
                    >
                        {
                            navbarOpen
                                ? (
                                    <a href="/" className="text-2xl text-white hover:text-[#E97665]">  </a>

                                ) : (
                                    <>
                                        <Link
                                            to="exposants"
                                            className="text-2xl tracking-wide lg:block hidden text-white hover:text-[#E97665]"
                                        >
                                            {' '}
                                            Exposants
                                        </Link>
                                        ...
                                        <Link
                                            to="billetterie"
                                            className="text-2xl tracking-wide lg:block hidden bg-[#E97665] px-3 text-white hover:text-black"
                                        >
                                            {' '}
                                            Billetterie
                                        </Link>
