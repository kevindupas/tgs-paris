            ...
            <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
                <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
                    <div className="px-5 py-2">
                        <Link to="presse" className="text-base text-white font-semibold"> Espace Presse & Pro </Link>
                    </div>

                    <div className="px-5 py-2">
                        <Link to="staffs" className="text-base text-white font-semibold"> Devenir staff </Link>
                    </div>

                    <div className="px-5 py-2">
                        <a href="mailto:partenariats@parismanga.fr" className="text-base text-white font-semibold"> Devenir partenaire </a>
                    </div>

                    <div className="px-5 py-2">
                        <Link to="devenir_exposants" className="text-base text-white font-semibold"> Devenir exposant </Link>
                    </div>
                ...
                <p className="mt-8 text-center text-base text-gray-400">
                    ...
                    {dayjs().year()}
                    {' '}
                    <a href="http://tgsevenements.com/" target="_blank" rel="noreferrer" className="text-[#E97665]">PM EVENEMENTS</a>
                    {' '}
                    - Tous droits réservés.
                    <br />
                    Design et Développement par
                    {' '}
                    <a href="https://kevindupas.com" target="_blank" rel="noreferrer" className="text-[#E97665]">Kévin Dupas</a>
                </p>
            </div>
        </footer>
    );
