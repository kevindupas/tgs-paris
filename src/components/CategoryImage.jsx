    ...
    <section className="relative h-[calc(100vh-100px)] overflow-hidden">
        ...
        <div className="w-full h-full relative overflow-hidden">
          {category.id === categoryId ? (
            <img
              ...
              alt=""
              className="w-full h-full object-cover lg:blur-none"
              loading="lazy"
            />
          ) : (
            <Loader />
          ...
          {/* Ajout du dégradé en bas de l'image */}
      ...
      <div className="relative z-10 pb-[40px] lg:pb-[69px] max-w-[1200px] w-[calc(100%-30px)] mx-auto h-full justify-end flex-col flex">
        <Fade delay={500} direction="up" triggerOnce>
          <h1 className="font-microgramma text-white text-[30px] lg:text-[96px] tracking-[0.566667px] leading-[.95] uppercase">
            {categoryName}
          </h1>
        </Fade>
      </div>
