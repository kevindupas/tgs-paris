...
export default function FaqWithSearch() {
  ...
  const filteredFaqs = sortedData.filter((value) =>
        ...
        <div className="bg-white">
          <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
            <div className="mx-auto max-w-4xl divide-y divide-gray-900/10">
              <h2 className="text-2xl font-bold leading-10 tracking-tight text-gray-900 pb-8">
                Questions fréquemment posées
              </h2>
              <div className="relative">
                <FontAwesomeIcon
                  icon={faMagnifyingGlass}
                  className="pointer-events-none absolute top-6 left-4 h-5 w-5 text-gray-400"
                />
                <input
                  type="text"
