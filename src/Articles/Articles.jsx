...
export default function Articles({ categoryName, categories }) {
  ...
  const getPostsToDisplay = () =>
    posts.filter(
      (post) =>
        activeTab === "Tous" || (post.tag && post.tag.name === activeTab)
    );
        ...
        {isDesktop ? (
          <section className="pt-[61px] pb-[53px]">
            <div className="max-w-[1200px] w-[calc(100%-30px)] mx-auto justify-start items-center flex-wrap flex">
              <h1 className="mr-9 w-auto flex-none font-tungsten font-semibold text-[56px] tracking-[0.566667px] leading-[.95] uppercase text-black">
                Filtres :
              </h1>
          ...
          <section className="pt-[61px] pb-[53px]">
            <div className="max-w-[1200px] w-[calc(100%-30px)] mx-auto justify-start items-center flex-wrap flex">
              <h1 className="mr-9 w-auto flex-none font-tungsten font-semibold text-[35px] tracking-[0.566667px] leading-[.95] uppercase text-black">
                Filtres :
              </h1>
