                            ...
                            <div className="space-x-3 flex justify-center items-center font-tungstenb_semibold font-medium uppercase overflow-y-hidden">
                                {tagList.map((tag) => (
                                    <button
                                        ...
                                        className={clsx('inline-flex items-center px-3 py-2 border hover:bg-blue-400 hover:text-white border-transparent leading-4 font-medium rounded-md shadow-sm', activeTab === tag ? 'bg-[#E97665] text-white' : 'bg-white text-black')}
                                    >
