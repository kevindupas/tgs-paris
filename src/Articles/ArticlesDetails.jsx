                                ...
                                ? (
                                    <div key={planning + SALON_ID} className="w-full lg:w-96 h-full bg-white mt-9 border border-gray-400 shadow-lg rounded-lg">
                                        <div className="relative p-6 space-y-6 lg:p-8">
                                            <h3 className="text-3xl text-center text-[#E97665] uppercase font-bold underline">Infos planning</h3>
                                            <div />
                                            ...
                                            <Link to="/billetterie" className="block w-full py-3 px-6 text-center rounded-xl transition bg-[#E97665] hover:bg-blue-400">
